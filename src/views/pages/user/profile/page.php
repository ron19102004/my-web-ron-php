...
<div class="flex flex-col justify-center items-center mt-20">
    <div class="relative flex flex-col items-center rounded-lg w-full max-w-4xl mx-auto bg-white shadow-lg p-6 border border-gray-200 ">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 w-full" data-aos="fade-up">
            <!-- Tên đầy đủ -->
            <div class="flex flex-col rounded-lg bg-gray-50 p-4 border">
            ...
            <div class="flex flex-col rounded-lg bg-gray-50   p-4 border" data-aos="fade-up">
                ...
                <p class="text-lg font-semibold text-gray-800  ">
                    <button data-modal-target="default-modal" data-modal-toggle="default-modal" class="inline-block text-green-600 bg-green-100 px-3 py-1 rounded font-medium cursor-pointer" type="button">
                        Đổi mật khẩu
                    </button>
                </p>
                    ...
                    <div class="relative p-4 w-full max-w-2xl max-h-full">
                        ...
                        <div class="relative bg-white rounded-lg shadow">
                            ...
                            <div class="p-4 md:p-5 space-y-4">
                                <div>
                                    <label for="current-password" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Mật khẩu hiện tại</label>
                                ...
                                <!-- Mật khẩu mới -->
                                <div>
                                    <label for="new-password" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Mật khẩu mới</label>
                                ...
                                <div>
                                    <label for="confirm-password" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Xác nhận mật khẩu mới</label>
                            ...
                            <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                                <button data-modal-hide="default-modal" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" id="changepw-btn">Xác nhận</button>
                                <button data-modal-hide="default-modal" type="button" class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 ">Hủy</button>
                            </div>
                        </div>
                    </div>
                </div>
